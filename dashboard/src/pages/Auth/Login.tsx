            ...
            <form className="w-full px-4 max-w-sm flex flex-col gap-4">
                ...
                <div className="w-full flex items-center justify-between">
                    <div className="w-full flex items-center">
                        ...
                        <label htmlFor="remember_me" className="ml-2 text-sm text-white">Remember Me</label>
                    </div>
                    <div className="w-full flex items-center justify-end">
                        <Link to="/forgot-password" className="text-sm hover:underline hover:underline-offset-8 text-white">Forgot Password?</Link>
                    </div>
                </div>
                <button className="w-full p-2 bg-white hover:bg-gray-800 text-black hover:text-white duration-200">Login</button>
                <Link to="/register" className="w-full text-center text-sm hover:underline hover:underline-offset-8 text-white">
